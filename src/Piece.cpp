...
double Piece::getRightDissimilarityValue(int inx) const { return rightDissimiliratyValues.at(inx); }
double Piece::getDownDissimilarityValues(int inx) const { return downDissimiliratyValues.at(inx); }
...
int Piece::checkPiece() { return this->bestBuddyUpId.size(); }
